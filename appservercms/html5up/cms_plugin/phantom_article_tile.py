...
class TestImagePlugin(LinkPluginBase, Html5UpPluginBase):
    name = _("Image")
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        return super(TestImagePlugin, self).get_form(request, obj, **kwargs)
    ...
    def get_css_classes(cls, obj):
        css_classes = super(TestImagePlugin, cls).get_css_classes(obj)
    ...
    def get_identifier(cls, obj):
        identifier = super(TestImagePlugin, cls).get_identifier(obj)
        try:
